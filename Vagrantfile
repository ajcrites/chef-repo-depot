...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ajcrites-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/ajcrites"
  #   chef.validation_client_name = "ajcrites-validator"
  #   chef.validation_key_path = ".chef/ajcrites-validator.pem"
  # end
end
